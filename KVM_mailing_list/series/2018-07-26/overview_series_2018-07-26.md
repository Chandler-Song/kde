#### [PATCH 1/2] KVM: PPC: Book3S HV: Allow creating max number of VCPUs
...
```
#### [kvm-unit-tests PATCH] Makefiles: Remove the executable bit from the
...
```
#### [PATCH v12 01/12] perf/x86/intel/pt: Move Intel-PT MSRs bit
...
```
#### [PATCH 1/3] KVM: x86: ensures all MSRs can always be
