#### [PATCH] KVM: PPC: Book3S HV: Provide mode where all vCPUs on a core
...
```
#### [PATCH v2 02/17] compat_ioctl: move drivers to
...
```
#### [PATCH] KVM: nVMX: Fix bad cleanup on error of get/set nested state
