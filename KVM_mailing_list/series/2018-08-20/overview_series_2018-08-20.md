#### [PATCH] KVM: PPC: Book3S HV: Don't truncate HPTE index in xlate
...
```
#### [PATCH] arm64: KVM: rename the capability to set guest SError
...
```
#### [PATCH] KVM: Documentation: rename the capability of
##### From: Dongjiu Geng <gengdongjiu@huawei.com>
...
```
#### [PATCH v3 1/3] KVM: x86: Turbo bits in MSR_PLATFORM_INFO
