#### [PATCH v2] KVM: Remove CREATE_IRQCHIP/SET_PIT2 race
...
```
#### [PATCH V5 1/4]  target-i386: introduce coalesced_pio kvm header
...
```
#### [kvm-unit-tests PULL 1/5] s390x: user ctl_set/clear_bit for low
...
```
#### [PATCH] KVM: nVMX: Unrestricted guest mode requires EPT
