#### [kvm-unit-tests PATCH] lib/s390x/io: Make sure that exit() is not
...
```
#### [PATCH] tools/kvm_stat: cut down decimal places in update interval
...
```
#### [PATCH v2 1/9] x86/kvm/mmu: make vcpu->mmu a pointer to the current
...
```
#### [PATCH] kvm: vmx: Remove a mysterious FIXME
